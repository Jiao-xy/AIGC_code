...
file_path = "/home/jxy/code/data/ieee-init.jsonl"  # 替换为你的 JSON 文件路径
output_file_path = "/home/jxy/code/data/ieee-init_llscore_ppl.jsonl"  # 输出 JSONL 文件
...
# **保存图像**
image_path = "LLScore_PPL_Distribution_human1.png"
